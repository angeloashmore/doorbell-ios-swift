...
// SwiftForms
#define COCOAPODS_POD_AVAILABLE_SwiftForms
#define COCOAPODS_VERSION_MAJOR_SwiftForms 0
#define COCOAPODS_VERSION_MINOR_SwiftForms 8
#define COCOAPODS_VERSION_PATCH_SwiftForms 0
